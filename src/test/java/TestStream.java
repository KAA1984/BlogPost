...
public class TestStream {
    ...
    public void shouldCountSumOfNumbersInTheList() {
        ...
        // when
        int quantity = listOfNumbers.stream().reduce(0, (acc, x) -> acc + x);
    ...
    public void shouldFilterAllNumbersGreaterThan5AndDividedBy2() {
        ...
        //int numbersGreaterThan5;
        List<Integer> numbersGreaterThan5 = numbers.stream().filter(x -> x > 5).filter(p -> p % 2 == 0).collect(Collectors.toList());
    ...
    public void shouldMultiplyAndTransformIntoStringEachElement() {
        ...
        // then
        Assertions.assertThat(multipliedNumbersAsString).contains("2", "4", "6", "8", "10");
    ...
    public void shouldCheckIfEachNumberIsEven() {
        ...
        // when
        boolean eachNumberIsEven = numbers.stream().anyMatch(x -> x % 2 == 0);
    ...
    public void shouldSortTheList() {
        ...
        // when
        Stream<String> sortedList = listOfWords.stream().sorted(); //colect to list
